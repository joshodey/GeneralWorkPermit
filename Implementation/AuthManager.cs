...
namespace GeneralWorkPermit.Implementation
{
    public class AuthManager : IAuthManager
    {
        ...
        public AuthManager(UserManager<Applicants> userManager, IConfiguration configuration, IEmailService emailService)
        {
        ...
        public async Task<bool> ValidateUser(Applicants user)
        {
